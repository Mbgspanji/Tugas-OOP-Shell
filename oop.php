...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    class Bensin {
        ...
        public function getHarga() {
            if ($this->jenis === "shellSup"){
                ...
                return $this->harga = 16000;
            }
            else if ($this->jenis === "shellVPowD"){
                return $this->harga = 18000;
            }
    ...
    echo "</table>";
    echo "<p>Jl. Raya Pajajaran No.99, RT.03/RW.03, Bantarjati, Kec. Bogor Utara, Kota Bogor, Jawa Barat 16153</p>";
    echo "<p>Shell Pajajaran </p>";
    echo "<button onclick='window.print()' class='btn btn-primary mt-3'>Cetak Struk</button>";
    echo "</div>";
}
?>
